...
plot_figure_4.py --> to plot figure 4 in the article 

seasonal_joint_pdfs_duacs.py --> joint pdf for DUACS, figure 5 in the article

seasonal_joint_pdfs.py --> joint pdf for SWOT, figure 5 in the article

derive_spectra_pdf_l3.py --> SSH spectrum + PDFs for SWOT L3 data + plot maps of strain and relative vorticity (figure 6 in the article)

plot_figures_spectra_pdf.py --> to plot spectra or single pdf (not joint) for several products (DUACS, SWOT) (figure 7 in the article)

plot_figure_8.py --> to plot figure 8 in the article
